  ...
  return (
    <footer className="w-full bg-gray-900 text-gray-300 mt-16 pt-10 border-t border-gray-700">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className="hover:text-orange-400 cursor-pointer transition">Find Jobs</li>
            <li className="hover:text-orange-400 cursor-pointer transition">Post a Job</li>
            <li className="hover:text-orange-400 cursor-pointer transition">Career Tips</li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className="hover:text-orange-400 cursor-pointer transition">FAQs</li>
      ...
      <div className="text-center text-gray-500 py-4 border-t border-gray-700 mt-10 text-sm">
        © {new Date().getFullYear()} <span className="text-orange-400 font-semibold">HireSphere</span>.  
        All Rights Reserved.
      </div>
    </footer>
  );
