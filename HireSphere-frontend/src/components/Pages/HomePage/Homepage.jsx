			...
			<div className="flex flex-col-reverse  md:flex-row items-center justify-center px-6 sm:px-10 md:px-16 bg-white text-gray-900 overflow-visible max-w-full">
				...
				<div className="flex flex-col w-full md:w-[50%] gap-6 text-center md:text-left">
					<h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight">
						Find Your{" "}
						<span className="text-orange-400 drop-shadow-md">Dream Job</span>{" "}
						with Us
					</h1>
					...
					{/* Search Section */}
					<div className="flex flex-col sm:flex-row sm:mb-1 items-center gap-3 bg-gray/20 backdrop-blur-md p-4 rounded-2xl shadow-lg mt-4 border border-gray/10 required">
						...
						/> */}
							<select className="p-2 rounded-lg bg-white/10 border border-gray-600 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-400 transition-all">
								...
								<option className="">Internship</option>
						...
						<button
							...
							className="flex mt-0 sm:mt-4 items-center justify-center w-full h-14 sm:h-12 p-3 bg-orange-400 rounded-xl hover:bg-orange-500 active:scale-95 transition-transform cursor-pointer shadow-md">
